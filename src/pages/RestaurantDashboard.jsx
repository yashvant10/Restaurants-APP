...
export default function RestaurantDashboard() {
  ...
  const fetchRestaurantProfile = async () => {
    ...
    try {
      const res = await api.get('/api/restaurant/me');
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col font-sans">
      ...
      {/* 1. Header Navigation */}
      <nav className="sticky top-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200/50 dark:border-slate-800/50 z-20 px-6 py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
